...
<div class="header"><a>
  ...
  <div class="header-right">
    <a class="active" href="/tem/indexx.php">Home</a>
...
<img src="/tem/images/text.png">

<a href="marquee tag.php" class="button button2">preview</a>


<a href="tab tag.php" class="button button2">next</a>
  <center>
    
</div>

    
<a href="/tem/zip/textarea.zip" class="button button5">click me for download code</a>
<a href="/tem/demo/textarea.php" class="button button5">Demo</a>
