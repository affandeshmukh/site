...
<div class="header"><a>
  ...
  <div class="header-right">
    <a class="active" href="/tem/index.php">Home</a>
...
<div id="mySidenav" class="sidenav">
  ...
  <a class="active" href="tab tag.php">Tab tag</a>
...
function closeNav() {
 ...
 <img src="/tem/images/tab.png">

<a href="textarea.php" class="button button2">preview</a>


<a href="scroll the page.php" class="button button2">next</a>
  <center>
 
</div>

<a href="/tem/zip/tab tag.zip" class="button button5">click me for download code</a>
<a href="/tem/demo/tab tag.php" class="button button5">Demo</a>
