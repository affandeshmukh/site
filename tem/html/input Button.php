...
<div id="mySidenav" class="sidenav">
  ...
  <a class="active" href="Input Button.php">Input button</a>
...
<strong><h3>GO TO DEMO</h3></strong>
<center>
<a href="scroll the page.php" class="button button2">&larr; preview </a>    
<a href="/tem/zip/input button.zip" class="button button5">click me for download code</a>
<a href="/tem/demo/input button.php" class="button button5">Demo</a>
