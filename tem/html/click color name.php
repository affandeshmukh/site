...
<div id="mySidenav" class="sidenav">
  ...
  <a class="active" href="Click color name.php">Click color name</a>
...
<a href="tem/zip/automatic change color.zip" class="button button5">click me for download code</a>
<a href="tem/demo/automatic change color.html" class="button button5">Demo</a>

<a href="image link.php" class="button button2">next</a>
